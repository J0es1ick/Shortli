...
const en = {
  ...
  "home.platform.analytics": "Analytics",
  "home.platform.safety": "Protection",
  "home.platformImmutable": "DESTINATION LOCKED",
  "home.platformRealtime": "LIVE DATA",
  ...
  "home.benefitsLabel": "02 / MEMBER WORKSPACE",
  ...
  "privacy.storage.body": "Account and link data remains stored while the relevant account or link exists. Click events are attached to their link and are removed when that link is deleted. Sessions expire seven days after sign-in and are not extended by page visits.",
  "privacy.storage.delete": "You can delete individual links or your account through the service. Deleting an account also deletes all links owned by it. Database backups and infrastructure logs, when enabled by the hosting provider, may require a limited additional period to rotate.",
  ...
  "admin.usersEmpty": "No matching users found.",
  "admin.usersLoadError": "The user directory could not be loaded.",
  "admin.userUpdateError": "The user role could not be updated.",
  "admin.joined": "Joined",
  "admin.accessRole": "Access role",
  "admin.saveRole": "Save role",
  "admin.savingRole": "Saving…",
  "admin.roleSaved": "Saved ✓",
...
const ru: Record<TranslationKey, string> = {
  ...
  "home.platform.analytics": "Аналитика",
  "home.platform.safety": "Защита",
  "home.platformImmutable": "АДРЕС ЗАФИКСИРОВАН",
  "home.platformRealtime": "ЖИВЫЕ ДАННЫЕ",
  ...
  "home.benefitsLabel": "02 / ЛИЧНОЕ ПРОСТРАНСТВО",
  ...
  "privacy.storage.body": "Данные аккаунта и ссылок хранятся, пока существует соответствующий аккаунт или ссылка. События переходов связаны со ссылкой и удаляются вместе с ней. Сессия завершается через семь дней после входа и не продлевается при просмотре страниц.",
  "privacy.storage.delete": "Можно удалить отдельные ссылки или аккаунт через сервис. При удалении аккаунта удаляются и все принадлежащие ему ссылки. Резервным копиям и инфраструктурным журналам, если они ведутся хостинг-провайдером, может потребоваться дополнительное ограниченное время для ротации.",
  ...
  "admin.usersEmpty": "Подходящие пользователи не найдены.",
  "admin.usersLoadError": "Не удалось загрузить список пользователей.",
  "admin.userUpdateError": "Не удалось изменить роль пользователя.",
  "admin.joined": "Регистрация",
  "admin.accessRole": "Роль доступа",
  "admin.saveRole": "Сохранить роль",
  "admin.savingRole": "Сохраняем…",
  "admin.roleSaved": "Сохранено ✓",
